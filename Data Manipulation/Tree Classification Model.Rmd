...
tree <- ctree(final_result ~ dataplus + forumng + glossary + homepage + oucollaborate + oucontent + resource + subpage + url, data=df.train)
...
```{r}
df.test$prediction <- predict(tree, df.test)
