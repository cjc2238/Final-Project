...
tree_plot + geom_tile(aes(x=Var1, y=Var2, fill=Freq), color = "gray") + scale_x_discrete(name="Actual Class") + scale_y_discrete(name="Predicted Class") + scale_fill_gradient(breaks=seq(from=-0, to=110, by=15), high = "blue") + labs(fill="Frequency") + geom_text(data = tree_confusion, aes(x=Var1, y=Var2, label=Freq), color = "white")
